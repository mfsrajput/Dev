...
function updateDisplay() {
  const displayPreviousInput = document.getElementById("previous-input") as HTMLElement;
  const displayOperator = document.getElementById("operator") as HTMLElement;
  const displayCurrentInput = document.getElementById("current-input") as HTMLElement;
